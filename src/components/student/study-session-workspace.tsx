...
export function StudySessionWorkspace({ lessonId }: { lessonId: string }) {
  ...
  function skipProblem() {
    ...
    const confirmed = window.confirm("Bỏ qua bài này? Bài sẽ được ghi là đã bỏ qua. Phần đã thử vẫn được lưu để đánh giá; bỏ qua không được tính là đã nắm vững.");
